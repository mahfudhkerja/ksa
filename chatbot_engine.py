...
SYSTEM_PROMPT = (
    ...
    "baris baru (karakter enter/newline), JANGAN PERNAH menyambung semua "
    "poin jadi satu paragraf panjang yang cuma dipisah spasi. Kalau satu "
    "poin sendiri masih panjang/banyak detail (mis. beberapa catatan "
    "sekaligus), boleh dipecah lagi jadi sub-baris di bawahnya (indented), "
